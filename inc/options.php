<?php
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Глобальные настройки', 'redux-framework-demo' ),
        'id'               => 'globalsettings',
        'desc'             => __( 'Здесь все настройки сайта', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'desc'             => __( 'Все что связанно с шапкой сайта', 'redux-framework-demo' ) ,
        'fields'           => array(
            array(
                'id'       => 'logo',
                'type'     => 'media',
            ...
            array(
                ...
                'subtitle' => __( 'Номер телефона', 'redux-framework-demo' ),
                'desc'     => __( 'Введите номер телефона', 'redux-framework-demo' ),
            ...
            array(
                ...
                'subtitle' => __( 'Введите email', 'redux-framework-demo' ),
                'desc'     => __( 'Введите email', 'redux-framework-demo' ),
                'default'  => 'Default Text' ,
            ),
        )
    ) );
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'     => array(
            array(
                'id'       => 'social',
                'type'     => 'sortable',
                'title'    => __( 'Соцальные сети', 'redux-framework-demo' ),
    ...
    Redux::setSection( $opt_name, array(
        'title'            => __( 'Подвал сайта', 'redux-framework-demo' ),
